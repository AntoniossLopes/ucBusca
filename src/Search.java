...
public class Search implements Serializable {
    ...
    public void leObjecto() throws IOException, ClassNotFoundException {
        ...
        try {
            File ficheiro = new File("baseObjeto.ser");
            if (ficheiro.length() == 0) {
                ...
                this.listaSites = (List<Site>) ois.readObject();
                this.urls = (List<String>) ois.readObject();
                this.urlMap = (Map<String, HashSet>) ois.readObject();
                this.pais = (Map<String, HashSet<String>>) ois.readObject();
